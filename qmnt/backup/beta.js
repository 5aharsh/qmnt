    ...
    function(){
        ...
        $('#qmnt-form').submit(function(){
                ...
                if(comment!="" && comment.length>=5 && name!=""){
                    if($('#qmnt-website').val()!=""){
                        $('#qmnt-section').prepend("<details open><summary><a href='"+website+"'>"+ name +"</a> | "+ date +" </summary><blockquote>"+ comment +"</blockquote></details>");
                    }
                    else{
                        $('#qmnt-section').prepend("<details open><summary>"+ name +" | "+ date +" </summary><blockquote>"+ comment +"</blockquote></details>");
                    }
                    $('#qmnt-con').val("");
